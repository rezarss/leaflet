  ...
  return (
    <>
      ...
      <div className="relative rounded-md border-2 z-0">
        <button onClick={() => setMapType(mapType === 'openstreetmap' ? 'mapbox' : 'openstreetmap')} className="absolute top-4 right-4 bg-white text-sm p-2 rounded shadow z-10 cursor-pointer focus:outline-none dark:text-black">
